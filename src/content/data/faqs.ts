...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "樂圖漫遊會館提供機場及港口接送服務，免費接送以官方電話、LINE 或官網直接訂房之旅客為主。若有需要，請於入住前提前告知抵達時間、班機或船班資訊及同行人數，我們會依當日行程、人力與車輛狀況協助安排，並以民宿最終確認為準。\n\n透過 Booking、Agoda 等第三方訂房平台預訂者，接送服務依平台方案與民宿安排為準，恕不保證提供免費接送。",
    category: "location",
    contentStatus: "verified",
    published: false,
    priority: 30,
